...
export default function CTASection({ trainer, branding, formData, result, goalLabel }: CTASectionProps) {
  ...
  return (
    <div className="rounded-2xl p-8 text-center" style={{ backgroundColor: branding.color_primary + '10' }}>
      ...
      {trainer.booking_link && (
        <a href={trainer.booking_link} target="_blank" rel="noopener noreferrer"
